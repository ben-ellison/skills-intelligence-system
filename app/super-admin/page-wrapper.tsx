    ...
    <div className="min-h-screen bg-slate-50 p-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-6 mb-8">
          ...
          <Link
            href="/super-admin/database-schemas"
            className="bg-white rounded-lg shadow-sm p-6 hover:shadow-md transition-shadow"
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-slate-900">Database Schemas</h3>
                <p className="text-sm text-slate-600">Field mappings (BUD, Aptem, etc.)</p>
              </div>
            </div>
          </Link>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-600">PowerBI & global config</p>
              </div>
            </div>
          </Link>
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="font-semibold text-slate-900">AI Settings</h3>
                <p className="text-sm text-slate-600">AI prompts & configuration</p>
              </div>
            </div>
          </Link>
        </div>
